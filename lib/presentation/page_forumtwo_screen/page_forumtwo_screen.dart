import '../page_forumtwo_screen/widgets/post_item_widget.dart';
...
class PageForumtwoScreen extends GetWidget<PageForumtwoController> {
  const PageForumtwoScreen({Key? key}) : super(key: key);
            ...
            appBar: CustomAppBar(
                ...
                actions: [
                  ...
                  AppbarCircleimage(
                      ...
                      margin:
                          EdgeInsets.only(left: 38.h, top: 15.v, right: 40.h),
                      onTap: () {
                        onTapIconavatarone();
                      })
                ],
                            ...
                            Row(
                                ...
                                children: [
                                  Padding(
                                      ...
                                      child: Text("msg_tr_ng_quang_khang".tr,
                                          style: CustomTextStyles
                                              .bodySmallBlack900)),
                  ...
                  Expanded(
                      child: Container(
                          ...
                          child: Obx(() => ListView.separated(
                              ...
                              itemCount: controller.pageForumtwoModelObj.value
                                  .postItemList.value.length,
                              itemBuilder: (context, index) {
                                PostItemModel model = controller
                                    .pageForumtwoModelObj
                                    .value
                                    .postItemList
                                    .value[index];
