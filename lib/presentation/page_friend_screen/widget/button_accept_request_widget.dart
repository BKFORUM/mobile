...
class ButtonAcceptRequestWidget extends StatefulWidget {
  @override
  _ButtonAcceptRequestState createState() => _ButtonAcceptRequestState();
}

class _ButtonAcceptRequestState extends State<ButtonAcceptRequestWidget> {
